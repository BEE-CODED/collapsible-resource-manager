        ...
        <div ref="viewport"
            ...
            <div ref="fixedMenu"
                ...
                <div class="pb-2 flex flex-col justify-center items-center pt-4 mt-4 space-y-2">
                    ...
                    <div
                        class="bg-gradient-to-t from-white dark:from-gray-800 to-transparent absolute -top-10 h-10 w-full pointer-events-none"/>

                    <component :is="NotificationCenter"
                               v-if="config.move_notification_center && notificationCenterEnabled"/>
